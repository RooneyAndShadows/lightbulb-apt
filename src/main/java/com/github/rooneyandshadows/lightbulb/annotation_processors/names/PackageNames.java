...
public class PackageNames {
    public static final String GENERATED_LB_ROUTING = "com.github.rooneyandshadows.lightbulb.routing";
    public static final String GENERATED_LB_SCREENS = GENERATED_LB_ROUTING + ".screens";
